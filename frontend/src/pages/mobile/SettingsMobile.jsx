...
export default function SettingsMobile() {
  ...
  const SECTIONS = [
    ...
    // Adding a teammate lived here for a while, when the roster had been
    // folded into Ops and Settings was the only screen left that could own
    // creating one. U7-09 gave Team its own page again, so the row went back
    // with it — one door to the roster, and this screen is configuration.
