...
export function ProfileForm({ onSaved }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <label className="text-label text-text-secondary">Mobile number</label>
        ...
        <p className="text-label text-text-secondary mt-1">Used for OTP login and to route your WhatsApp messages to this workspace.</p>
      </div>
      <div>
        ...
        <p className="text-label text-text-secondary mt-1">Email is your sign-in ID and can't be changed here.</p>
      </div>
      <button onClick={save} disabled={saving} data-testid="profile-save"
        className="flex items-center justify-center gap-2 bg-primary text-primary-foreground px-5 py-2.5 text-sm font-semibold rounded-lg hover:bg-primary-hover transition-colors disabled:opacity-50">
...
export function ChangePasswordForm() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <label className="text-label text-text-secondary">Current password</label>
      ...
      <div>
        <label className="text-label text-text-secondary">New password</label>
      ...
      <div>
        <label className="text-label text-text-secondary">Confirm new password</label>
