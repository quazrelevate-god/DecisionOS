        ...
        <div className="p-6">
            ...
            {chips.map((c, i) => {
              ...
              return (
                <div key={c.key} data-testid={`es-chip-${c.key}`}
                  className="border border-black p-3 flex items-center gap-3 es-reveal"
          ...
          <div className="mt-5 flex gap-2">
            ...
            <button onClick={onClose} data-testid="es-close-btn"
              className={`${hasApprovals ? "" : "flex-1 "}px-5 py-2.5 text-sm font-semibold uppercase tracking-wider border border-black hover:bg-black/5 transition-colors`}>
