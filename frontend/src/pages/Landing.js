    ...
    <div className="max-w-6xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <Link to="/signup" data-testid="landing-signup-btn"
          className="bg-brand-600 text-white text-sm font-semibold uppercase tracking-wider px-4 sm:px-5 py-2 border border-brand-600 hover:bg-white hover:text-brand-600 transition-colors">
          Sign up
        </Link>
      </div>
    </div>
...
const Kicker = ({ children, big }) => (
  <div className={`font-mono uppercase tracking-[0.25em] mb-4 text-brand-600 ${big ? "text-sm sm:text-base" : "text-xs"}`}>{children}</div>
);
...
const Dept = ({ icon: Icon, tag, title, children }) => (
  <div className="border-2 border-black bg-white p-6 hover:shadow-brutal transition-all">
    <div className="flex items-center gap-2 text-brand-600 mb-2"><Icon size={18} weight="bold" /><span className="font-mono text-[11px] uppercase tracking-widest">{tag}</span></div>
    ...
    <div className="bg-white text-[#16161a]" data-testid="landing-page">
      ...
      <section className="bg-[#16161a] text-white">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-24 sm:py-32">
          ...
          <div className="h-1.5 w-20 bg-brand-600 my-8" />
          ...
          <div className="flex flex-wrap gap-3 mt-10">
            <Link to="/signup" data-testid="hero-signup-btn"
              className="flex items-center gap-2 bg-brand-600 text-white text-sm font-semibold uppercase tracking-wider px-6 py-3 border border-brand-600 hover:bg-white hover:text-brand-600 transition-colors">
          ...
          <p className="font-mono text-[11px] uppercase tracking-widest text-white/40 mt-8">Voice · Text · WhatsApp · Documents — captured once, executed forever</p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-20">
          ...
          <div className="grid sm:grid-cols-2 gap-5 mt-10">
            ...
            <div className="border-2 border-[#16161a] bg-white p-6">
              <div className="font-mono text-xs uppercase tracking-widest text-brand-600 mb-2">The DecisionOS way</div>
      ...
      <section className="bg-[#16161a] text-white">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-20">
          ...
          <h2 className="font-heading font-black tracking-tight text-3xl sm:text-4xl leading-tight max-w-3xl">One sentence. A company-wide rule, <span className="text-brand-600">enforced.</span></h2>
          <div className="mt-10 space-y-4 max-w-3xl">
            <div className="border-l-4 border-brand-600 pl-5 py-2">
              <div className="font-mono text-[11px] uppercase tracking-widest text-brand-600/90">Second 0 — the owner speaks</div>
            ...
            <div className="border-l-4 border-brand-600 pl-5 py-2">
              <div className="font-mono text-[11px] uppercase tracking-widest text-brand-600/90">Second 3 — the AI understands</div>
            ...
            <div className="border-l-4 border-brand-600 pl-5 py-2">
              <div className="font-mono text-[11px] uppercase tracking-widest text-brand-600/90">Second 10 — the business changes</div>
          ...
          <div className="grid md:grid-cols-3 gap-5 mt-10">
            {[
              ...
              <div key={s.t} className="border-2 border-black p-6 relative">
                ...
                <s.icon size={26} weight="bold" className="text-brand-600" />
          ...
          <div className="grid sm:grid-cols-2 gap-4 mt-8">
            {[
              ...
              <div key={x.t} className="border-2 border-black bg-white p-5">
                <div className="flex items-center gap-2 text-brand-600 mb-2"><WarningCircle size={16} weight="bold" /><span className="font-mono text-[11px] uppercase tracking-widest">{x.t}</span></div>
                <p className="font-semibold text-sm">{x.a}</p>
                <p className="text-sm text-muted-foreground mt-1">{x.r}</p>
              </div>
            ))}
          </div>
          <p className="mt-6 text-lg">Every alert is <span className="text-brand-600 font-semibold">one tap from action</span> — turn it into a task, assign it, done.</p>
        </div>
      </section>
          ...
          <div className="grid sm:grid-cols-3 gap-5 mt-10">
            {[
              ...
              <div key={x.t} className="border border-white/15 bg-white/5 p-6">
                <Lightning size={20} weight="bold" className="text-brand-600" />
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-20 text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center mt-10">
            <Link to="/signup" data-testid="cta-signup-btn"
              className="flex items-center gap-2 bg-white text-brand-600 text-sm font-semibold uppercase tracking-wider px-7 py-3 border border-white hover:bg-transparent hover:text-white transition-colors">
              Start free <ArrowRight size={16} weight="bold" />
            </Link>
            <Link to="/login" data-testid="cta-login-btn"
              className="border border-white/60 text-white text-sm font-semibold uppercase tracking-wider px-7 py-3 hover:bg-white hover:text-brand-600 transition-colors">
              Log in
            </Link>
          </div>
        </div>
