...
ASKS = [
    ...
    dict(
        ...
        type='Change request',
        prio='High',
        what='Plan: docs/TASK_MANAGEMENT_PLAN.md Phase 1; checklist: https://claude.ai/code/artifact/53a2b23e-66a5-4eeb-bfb3-52a87ce08043. TK-01 Asked by me (tasks I created for others). TK-02 Waiting for my approval (named approver, or anyone with approvals when none is named). TK-03 My team (doer or helper reports to me, via reporting_manager_id). TK-04 /my-work?task= opens the task even when it is not in the current view.',
