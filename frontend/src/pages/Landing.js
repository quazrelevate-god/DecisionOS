    ...
    <div className="bg-white text-[#16161a]" data-testid="landing-page">
      ...
      <section className="bg-[#16161a] text-white">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-20">
          ...
          <p className="text-lg mt-8 max-w-2xl">Not a to-do — <span className="text-brand-red font-semibold">an operational change, running itself.</span></p>
        </div>
      </section>
      ...
      <section className="bg-[#f7f5f2]">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-20">
          ...
          <p className="mt-6 text-lg">Every alert is <span className="text-brand-red font-semibold">one tap from action</span> — turn it into a task, assign it, done.</p>
        </div>
      </section>
