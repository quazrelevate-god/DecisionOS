    ...
    <div className="max-w-6xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        <Link to="/login" data-testid="landing-login-btn"
          className="text-white/90 hover:text-white text-sm font-medium px-3 sm:px-4 py-2 transition-colors">
          Log in
        </Link>
        <Link to="/signup" data-testid="landing-signup-btn"
          className="bg-brand-600 text-white text-sm font-medium px-4 sm:px-5 py-2 border border-brand-600 hover:bg-white hover:text-brand-600 transition-colors">
          Sign up
        </Link>
      </div>
    </div>
    ...
    <div className="bg-white text-[#16161a]" data-testid="landing-page">
      ...
      <section className="bg-[#16161a] text-white">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-24 sm:py-32">
          ...
          <h1 className="font-medium text-5xl sm:text-6xl lg:text-7xl leading-[1.02]">
          ...
          <div className="flex flex-wrap gap-3 mt-10">
            <Link to="/signup" data-testid="hero-signup-btn"
              className="flex items-center gap-2 bg-brand-600 text-white text-sm font-medium px-6 py-3 border border-brand-600 hover:bg-white hover:text-brand-600 transition-colors">
              Get started free <ArrowRight size={16} weight="bold" />
            </Link>
            <a href="#how" className="flex items-center gap-2 border border-white/40 text-white text-sm font-medium px-6 py-3 hover:bg-white hover:text-[#16161a] transition-colors">
              See how it works
            </a>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-12">
          ...
          <div className="grid sm:grid-cols-2 gap-5 mt-10">
            <div className="border-2 border-[#16161a] bg-[#16161a] text-white p-6">
              <div className="font-mono text-xs  text-white/50 mb-2">The old way</div>
            ...
            <div className="border-2 border-[#16161a] bg-white p-6">
              <div className="font-mono text-xs  text-brand-600 mb-2">The DecisionOS way</div>
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-12">
          ...
          <div className="grid md:grid-cols-3 gap-5 mt-10">
            {[
              ...
              <div key={s.t} className="border border-border p-6 relative">
                ...
                <h3 className="font-heading font-medium tracking-tight text-xl mt-3">{s.t}</h3>
          ...
          <div className="grid sm:grid-cols-3 gap-5 mt-10">
            {[
              ...
              <div key={x.t} className="border border-white/15 bg-white/5 p-6">
                ...
                <h3 className="font-heading font-medium tracking-tight text-base mt-3">{x.t}</h3>
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-12 text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center mt-10">
            <Link to="/signup" data-testid="cta-signup-btn"
              className="flex items-center gap-2 bg-white text-brand-600 text-sm font-medium px-7 py-3 border border-white hover:bg-transparent hover:text-white transition-colors">
              Start free <ArrowRight size={16} weight="bold" />
            </Link>
            <Link to="/login" data-testid="cta-login-btn"
              className="border border-white/60 text-white text-sm font-medium px-7 py-3 hover:bg-white hover:text-brand-600 transition-colors">
              Log in
            </Link>
          </div>
        </div>
