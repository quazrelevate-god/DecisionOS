...
export function OsReady({ industryLabel, summary, onContinue }) {
  ...
  return (
    <div className="space-y-5" data-testid="onboarding-os-ready">
      ...
      <button data-testid="os-ready-continue" onClick={onContinue} className="w-full flex items-center justify-center gap-2 bg-brand-red text-white font-semibold uppercase tracking-wider py-3 border border-black hover:shadow-brutal transition-all">
