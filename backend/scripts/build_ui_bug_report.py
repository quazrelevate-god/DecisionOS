...
COVERAGE = [
    ...
    ('T-690', 'My Work', 'All Tasks - filter row', 'Desktop 1440x900', 'Owner', 'All Tasks shows Department, Person, Priority, Status; My Tasks hides Person', 'Filters', 'PASS', 'Row shows all four with counts (131); My Tasks shows three (25)', 'ASK-24'),
    ...
    ('T-693', 'My Work', 'All Tasks - Priority filter', 'Desktop 1440x900', 'Owner', 'Priority dropdown exists and narrows', 'Filters', 'PASS', 'High 66 / Medium 53 / Low 12; Priya x Overdue x High = 16 = API', 'ASK-24'),
    ...
    ('T-695', 'My Work', 'All Tasks - refresh, Clear, no match', 'Desktop 1440x900', 'Owner', 'Filters survive refresh; Clear resets; empty result explains itself', 'Filters', 'PASS', "Reload keeps 16 cards + URL; Clear -> 131, URL clean; Priya x Under Review -> 'No tasks match these filters' with Clear", 'ASK-24'),
    ...
    ('T-697', 'My Work', 'Phone - filter sheet', 'Mobile 390x844', 'Owner', 'The phone reaches all four filters and sees what is active', 'Filters', 'PASS', "Sheet with Department / Person / Priority / Status; Priya + Overdue -> 'Show 20 tasks' = 20 cards; caption 'Showing Priya Nair - Overdue' with Clear; buttons 44px, reachable; no overflow", 'ASK-24'),
