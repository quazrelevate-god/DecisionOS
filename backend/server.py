...
# _can_work_task now lives in `services/tasks.py`; re-export for the many
# call sites below (task-body/attachment/execution-plan/steps flows) that
# still live in this module.
from services.tasks import _can_work_task, _plan_progress  # noqa: E402, F401
