...
function DemoBadge() {
  return (
    <div
      className="pointer-events-none fixed bottom-[6.5rem] right-3 z-[45] rounded-full border border-primary/30 bg-primary-subtle px-3 py-1 font-mono text-[10px] uppercase tracking-[0.1em] text-primary shadow-sm lg:bottom-3"
